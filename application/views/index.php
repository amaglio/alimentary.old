      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->       
           ...
           <!--  Text based logo 
          <a class="navbar-brand" href="index.html">Alimentary<span>X</span></a>  -->
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right mu-main-nav">
            ...
            <li><a href="#mu-about-us">MIX</a></li>  
            <li><a href="#mu-about-us">GRANOLA</a></li>  
            <li><a href="#mu-about-us">FRUTOS SECOS</a></li>                    
            <li><a href="#mu-restaurant-menu">CONTACTANOS</a></li>                       
            <li>  
  ...
  <section id="mu-slider">
    <div class="mu-slider-area"> 
      ...
      <div class="mu-top-slider">
        ...
        <!-- Top slider single slide -->
        <div class="mu-top-slider-single">
          <img src="<?=base_url()?>assets/img/slider/3.jpeg" alt="img">
          <!-- Top slider content -->
          <div class="mu-top-slider-content">
            ...
            <div class="row">
              <div class="col-md-6">
               <div class="mu-about-us-left">     
                <img src="<?=base_url()?>assets/img/about-us.png" alt="img">           
                </div>
              </div>
              <div class="col-md-6">
            ...
            <div class="mu-gallery-content">
              ...
              <div class="mu-gallery-body">
                ...
                <div class="mu-single-gallery col-md-4">
                    <div class="mu-single-gallery-item">
	                    <figure class="mu-single-gallery-img">
	                      <a class="mu-imglink" href="<?=base_url()?>assets/img/gallery/1.jpg">
                          <img alt="img" src="<?=base_url()?>assets/img/gallery/1.jpg">
                           <div class="mu-single-gallery-info">
                              <img class="mu-view-btn" src="<?=base_url()?>assets/img/plus.png" alt="plus icon img">
                          </div> 
                        </a>
	                    </figure>            
                  	</div>
                ...
                <div class="mu-single-gallery col-md-4">
                  	 <div class="mu-single-gallery-item">
                        <figure class="mu-single-gallery-img">
                          <a class="mu-imglink" href="<?=base_url()?>assets/img/gallery/2.jpg">
                            <img alt="img" src="<?=base_url()?>assets/img/gallery/2.jpg">
                             <div class="mu-single-gallery-info">
                                <img class="mu-view-btn" src="<?=base_url()?>assets/img/plus.png" alt="plus icon img">
                            </div> 
                          </a>
                ...
                <div class="mu-single-gallery col-md-4">                  
                  	 <div class="mu-single-gallery-item">
                      <figure class="mu-single-gallery-img">
                        <a class="mu-imglink" href="<?=base_url()?>assets/img/gallery/3.jpg">
                          <img alt="img" src="<?=base_url()?>assets/img/gallery/3.jpg">
                           <div class="mu-single-gallery-info">
                              <img class="mu-view-btn" src="<?=base_url()?>assets/img/plus.png" alt="plus icon img">
                          </div> 
                        </a>
                ...
                <div class="mu-single-gallery col-md-4">                  
                  	<div class="mu-single-gallery-item">
                      <figure class="mu-single-gallery-img">
                        <a class="mu-imglink" href="<?=base_url()?>assets/img/gallery/4.jpg">
                          <img alt="img" src="<?=base_url()?>assets/img/gallery/4.jpg">
                           <div class="mu-single-gallery-info">
                              <img class="mu-view-btn" src="<?=base_url()?>assets/img/plus.png" alt="plus icon img">
                          </div> 
                        </a>
                ...
                <div class="mu-single-gallery col-md-4">                  
                  	<div class="mu-single-gallery-item">
                      <figure class="mu-single-gallery-img">
                        <a class="mu-imglink" href="<?=base_url()?>assets/img/gallery/5.jpg">
                          <img alt="img" src="<?=base_url()?>assets/img/gallery/5.jpg">
                           <div class="mu-single-gallery-info">
                              <img class="mu-view-btn" src="<?=base_url()?>assets/img/plus.png" alt="plus icon img">
                          </div> 
                        </a>
                ...
                <div class="mu-single-gallery col-md-4">                  
                   <div class="mu-single-gallery-item">
                      <figure class="mu-single-gallery-img">
                        <a class="mu-imglink" href="<?=base_url()?>assets/img/gallery/6.jpg">
                          <img alt="img" src="<?=base_url()?>assets/img/gallery/6.jpg">
                           <div class="mu-single-gallery-info">
                              <img class="mu-view-btn" src="<?=base_url()?>assets/img/plus.png" alt="plus icon img">
                          </div> 
                        </a>
                ...
                <div class="mu-single-gallery col-md-4">                  
                  	<div class="mu-single-gallery-item">
                      <figure class="mu-single-gallery-img">
                        <a class="mu-imglink" href="<?=base_url()?>assets/img/gallery/7.jpg">
                          <img alt="img" src="<?=base_url()?>assets/img/gallery/7.jpg">
                           <div class="mu-single-gallery-info">
                              <img class="mu-view-btn" src="<?=base_url()?>assets/img/plus.png" alt="plus icon img">
                          </div> 
                        </a>
                ...
                <div class="mu-single-gallery col-md-4">                  
                  	<div class="mu-single-gallery-item">
                      <figure class="mu-single-gallery-img">
                        <a class="mu-imglink" href="<?=base_url()?>assets/img/gallery/8.jpg">
                          <img alt="img" src="<?=base_url()?>assets/img/gallery/8.jpg">
                           <div class="mu-single-gallery-info">
                              <img class="mu-view-btn" src="<?=base_url()?>assets/img/plus.png" alt="plus icon img">
                          </div> 
                        </a>
                ...
                <div class="mu-single-gallery col-md-4">                  
                  	<div class="mu-single-gallery-item">
                      <figure class="mu-single-gallery-img">
                        <a class="mu-imglink" href="<?=base_url()?>assets/img/gallery/9.jpg">
                          <img alt="img" src="<?=base_url()?>assets/img/gallery/9.jpg">
                           <div class="mu-single-gallery-info">
                              <img class="mu-view-btn" src="<?=base_url()?>assets/img/plus.png" alt="plus icon img">
                          </div> 
                        </a>
            ...
            <div class="mu-chef-content">
              <ul class="mu-chef-nav">
                <li>
                  <div class="mu-single-chef">
                    <figure class="mu-single-chef-img">
                      <img src="<?=base_url()?>assets/img/chef/chef-1.jpg" alt="chef img">
                    </figure>
                ...
                <li>
                  <div class="mu-single-chef">
                    <figure class="mu-single-chef-img">
                      <img src="<?=base_url()?>assets/img/chef/chef-4.jpg" alt="chef img">
                    </figure>
                    <div class="mu-single-chef-info">
                      <h4>Marty Fukuda</h4>
